...
function Navbar() {
  return (
    <nav className="absolute w-full flex justify-between items-center p-10 max-xl:p-9 max-lg:p-8 max-md:p-6 text-white font-oxygen">
      <h1 className="font-thin text-2xl max-xl:text-[22px] max-lg:text-[20px] max-md:text-[18px]">
        <a href="/">
          <span className="text-cool-white font-extrabold">NEHEMIE</span>
          MOMBANGA
        </a>
      </h1>
